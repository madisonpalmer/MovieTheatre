...
$resultsPick = $thisDatabaseWriter->select($querypick, array($fnkUserId), 1, 0, 0, 0, false, false);
...
// form. Note it is best to follow the same order as declared in section 1c.
    ...
    $fnkUserId = (int) htmlentities($_POST["hidfnkUserId"], ENT_QUOTES, "UTF-8");
    //$dataInfo[] = $pmkUserId;
    print $pmkUserId;
    print $fnkUserId;
...
// SECTION: 2e Save Data
        ...
        try {
            ...
            $foreignKey = $thisDatabaseWriter->lastInsert();
        ...
        <form action="<?php print $phpSelf; ?>"
            ...
            <fieldset>
                ...
                <input type="hidden" id="hidUserId" name="hidUserId"
                       ...
                       >
                <input type="hidden" id="hidfnkUserId" name="hidfnkUserId"
                       value="<?php print $fnkUserId; ?>"
                       >
